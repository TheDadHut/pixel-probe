...
| `exif_rich.jpg` | 2 | Generated (`scripts/build_fixtures.py` via `piexif`) | 100×100 JPEG with Make/Model + Exif sub-IFD (ExposureTime, FNumber, ISOSpeedRatings, FocalLength, DateTimeOriginal) | _SHA varies with Pillow encoder; not asserted_ |
